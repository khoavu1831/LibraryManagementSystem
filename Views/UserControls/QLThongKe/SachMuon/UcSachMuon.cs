...
{
    public partial class UcSachMuon : UserControl
    {
        ...
        {
            var thongKeDict = _thongKeService.getSachMuonTheoNam(year);
            if (thongKeDict == null)
            {
            ...
            chartThongKe.Titles.Add($"Thống kê sách mượn theo quý - Năm {year}");
            ...
            chartThongKe.ChartAreas["MainArea"].AxisY.Title = "Số sách mượn";
