...
namespace LMS.Views.UserControls.QLThongKe.PhieuPhat
{
    public partial class UcPhieuPhat : UserControl
    {
        ...
        {
            var thongKeDict = _thongKeService.getPhieuPhatTheoNam(year);
            if (thongKeDict == null)
            {
            ...
            chartThongKe.Titles.Add($"Thống kê phiếu phạt theo quý - Năm {year}");
            ...
            chartThongKe.ChartAreas["MainArea"].AxisY.Title = "Số phiếu phạt";
