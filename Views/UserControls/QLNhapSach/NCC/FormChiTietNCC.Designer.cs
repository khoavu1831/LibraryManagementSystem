namespace LMS.Views.UserControls.QLNhapSach
{
    partial class FormChiTietNCC
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelTitle.Text = "CHI TIẾT NHÀ CUNG CẤP";
            ...
            tableLayoutPanelContent.Controls.Add(textBoxIdNCC, 1, 0);
            ...
            tableLayoutPanelContent.Controls.Add(textBoxTenNCC, 1, 1);
            ...
            // textBoxIdNCC
            // 
            textBoxIdNCC.Enabled = false;
            textBoxIdNCC.Location = new Point(111, 2);
            textBoxIdNCC.Margin = new Padding(3, 2, 3, 2);
            textBoxIdNCC.Name = "textBoxIdNCC";
            textBoxIdNCC.ReadOnly = true;
            textBoxIdNCC.Size = new Size(244, 23);
            textBoxIdNCC.TabIndex = 8;
            // 
            // label1
            // 
            ...
            // textBoxTenNCC
            // 
            textBoxTenNCC.Enabled = false;
            textBoxTenNCC.Location = new Point(111, 30);
            textBoxTenNCC.Margin = new Padding(3, 2, 3, 2);
            textBoxTenNCC.Name = "textBoxTenNCC";
            textBoxTenNCC.ReadOnly = true;
            textBoxTenNCC.Size = new Size(244, 23);
            textBoxTenNCC.TabIndex = 2;
            // 
            // FormChiTietNCC
            // 
