...
namespace LibraryManagementSystem.Views.UserControls.QLMuonTraSach.MuonSach
{
    public partial class FormThemMuonSach : Form
    {
        ...
        {
            MessageBox.Show("Đã tạo phiếu mượn. (Thêm logic DB vào)", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void FormThemMuonSach_Load(object sender, EventArgs e)
        {
