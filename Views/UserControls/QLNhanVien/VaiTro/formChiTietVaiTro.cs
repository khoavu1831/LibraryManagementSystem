...
namespace LMS.Views.UserControls.QLNhanVien.VaiTro
{
    public partial class FormChiTietVaiTro : Form
    {
        ...
        private LMS.Entities.VaiTro _currentVaiTro;  // Lưu vai trò hiện tại
        ...
        // Render checkboxes (giống FormThemVaiTro, nhưng enabled=false cho view, và checked từ checkedQuyenIds)
        private void RenderQuyenCheckboxes(List<int>? checkedQuyenIds = null)
        {
            ...
            foreach (var module in modules)
            {
                ...
                var cbThem = new CheckBox
                {
                    ...
                    Enabled = false,  // Read-only cho chi tiết
                    AutoSize = false,
                    Dock = DockStyle.Fill,
